...
class UtilTest extends FlatSpec with Matchers with BeforeAndAfter{
  ...
  "copying instances" should "create separate sets and editing one alias name should not edit the other" in {
    var firstSet = Set(compilerPlugin.Instance(Set(compilerPlugin.Alias("cat", mutable.Stack("here"))),Set(ProtocolDSL.State("state1", 1))))
  ...
  "copying instances" should "create separate sets and editing one set should not edit the other" in {
    var firstSet:Set[Instance] = Set(compilerPlugin.Instance(Set(compilerPlugin.Alias("cat", mutable.Stack("here"))),Set(ProtocolDSL.State("state1", 1))))
    var secondInstances= copyInstances(firstSet)
    firstSet+= Instance(null,null)
    assert(secondInstances.last.aliases.last.name == "cat")
  ...
  "merging one set with an empty one" should "give back the one set" in {
    val firstSet:Set[Instance] = Set(Instance(Set(Alias("myAlias", mutable.Stack("main"))), Set(State("init", 0))))
    val secondSet:Set[Instance] = Set()
  ...
  "merging an empty set with nonempty" should "give back the nonempty set" in {
    val firstSet:Set[Instance] = Set()
    val secondSet:Set[Instance] = Set(Instance(Set(Alias("myAlias", mutable.Stack("main"))), Set(State("init", 0))))
  ...
  "merging two sets with the same aliases in different states" should "give back a merged set" in {
    val firstSet:Set[Instance] = Set(Instance(Set(Alias("myAlias", mutable.Stack("main"))), Set(State("init", 0))))
    val secondSet:Set[Instance] = Set(Instance(Set(Alias("myAlias", mutable.Stack("main"))), Set(State("S1", 1))))
    val mergedSet:Set[Instance] = Set(Instance(Set(Alias("myAlias", mutable.Stack("main"))), Set(State("S1", 1), State("init", 0))))
  ...
  "merging two sets with different aliases in different states" should "give back a merged set" in {
    val firstSet:Set[Instance] = Set(Instance(Set(Alias("myAlias", mutable.Stack("main"))), Set(State("init", 0))))
    val secondSet:Set[Instance] = Set(Instance(Set(Alias("yourAlias", mutable.Stack("main"))), Set(State("S1", 1))))
    val mergedSet:Set[Instance] = Set(
      Instance(Set(Alias("myAlias", mutable.Stack("main"))), Set(State("init", 0))),
      Instance(Set(Alias("yourAlias", mutable.Stack("main"))), Set(State("S1", 1)))
    )
    assert(mergeInstanceStates(firstSet, secondSet) == mergedSet)
  }
  ...
  "merging two sets with some same aliases in different states" should "give back a merged set" in {
    val firstSet:Set[Instance] = Set(Instance(Set(Alias("myAlias", mutable.Stack("main"))), Set(State("init", 0))))
    val secondSet:Set[Instance] = Set(
      Instance(Set(Alias("myAlias", mutable.Stack("main"))), Set(State("S1", 1))),
      Instance(Set(Alias("anotherAlias", mutable.Stack("main"))), Set(State("S1", 1)))
    )
    val mergedSet:Set[Instance] = Set(
      Instance(Set(Alias("myAlias", mutable.Stack("main"))), Set(State("init", 0), State("S1", 1))),
      Instance(Set(Alias("anotherAlias", mutable.Stack("main"))), Set(State("S1", 1)))
    )
    assert(mergeInstanceStates(firstSet, secondSet) == mergedSet)
  }
  ...
  "merging two sets with some same aliases in different states, extra in both" should "give back a merged set" in {
    ...
    val secondSet:Set[Instance] = Set(
      Instance(Set(Alias("myAlias", mutable.Stack("main"))), Set(State("S1", 1))),
      Instance(Set(Alias("yetAnotherAlias", mutable.Stack("main"))), Set(State("S1", 1)))
    )
    val mergedSet:Set[Instance] = Set(
      Instance(Set(Alias("myAlias", mutable.Stack("main"))), Set(State("init", 0), State("S1", 1))),
      Instance(Set(Alias("anotherAlias", mutable.Stack("main"))), Set(State("S1", 1))),
  ...
  "merging two sets with multiple alises to merge" should "give back a merged set" in {
    val firstSet:Set[Instance] = Set(
      Instance(Set(Alias("myAlias", mutable.Stack("main"))), Set(State("init", 0))),
      Instance(Set(Alias("anotherAlias", mutable.Stack("main"))), Set(State("S2", 1)))
    )
    val secondSet:Set[Instance] = Set(
      Instance(Set(Alias("myAlias", mutable.Stack("main"))), Set(State("S1", 1))),
      Instance(Set(Alias("anotherAlias", mutable.Stack("main"))), Set(State("S1", 1)))
    ...
    val mergedSet:Set[Instance] = Set(
      Instance(Set(Alias("myAlias", mutable.Stack("main"))), Set(State("init", 0), State("S1", 1))),
      Instance(Set(Alias("anotherAlias", mutable.Stack("main"))), Set(State("S1", 1),State("S2", 1)))
    )
    assert(mergeInstanceStates(firstSet, secondSet) == mergedSet)
  }
  //endregion
